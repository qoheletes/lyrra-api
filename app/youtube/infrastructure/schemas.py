...
class YouTubeSearchRequest(BaseModel):
    ...
    page_token: Optional[str] = Field(default=None, description="Pagination token from a previous search")
...
class YouTubeTranslateRequest(BaseModel):
    youtube_url: HttpUrl
    model: str = Field(default="gpt-4o-mini-transcribe", description="OpenAI transcription model name")
